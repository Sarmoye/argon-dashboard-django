...
EMAIL_CONFIG = {
    ...
    'cis_recipients': ['Sarmoye.AmitoureHaidara@mtn.com', 'marcel.kassavi@mtn.com'],
    'irm_recipients': ['Sarmoye.AmitoureHaidara@mtn.com', 'marcel.kassavi@mtn.com'],
    'ecw_recipients': ['Sarmoye.AmitoureHaidara@mtn.com', 'marcel.kassavi@mtn.com'],
    'summary_recipients': ['Sarmoye.AmitoureHaidara@mtn.com', 'marcel.kassavi@mtn.com']
}
