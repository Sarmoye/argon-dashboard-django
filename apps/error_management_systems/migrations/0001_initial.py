# Generated by Django 3.2.6 on 2025-03-20 09:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_name', models.CharField(max_length=100, verbose_name='Service Name')),
                ('error_reason', models.TextField(verbose_name='Error Reason')),
                ('type_error', models.CharField(choices=[('expected', 'Expected'), ('unexpected', 'Unexpected')], default='unexpected', max_length=50, verbose_name='Error Type')),
