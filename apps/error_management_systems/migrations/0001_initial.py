# Generated by Django 3.2.6 on 2025-03-17 10:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('system_name', 'service_name', 'error_reason'), name='1unique_system_error_reason'),
        ),
        migrations.AddField(
            model_name='errorticket',
            name='error_type',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ticket', to='error_management_systems.errortype', verbose_name="Type d'erreur"),
        ),
        migrations.AddField(
            model_name='errorevent',
            name='error_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='error_management_systems.errortype', verbose_name="Type d'erreur"),
        ),
    ]
