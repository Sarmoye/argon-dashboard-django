...
def process_prestige_data():
    ...
    if processed_data:
        ...
        to_emails = ["Sarmoye.AmitoureHaidara@mtn.com", "dominique.lokossou@mtn.com", "moucharaf.amadou@mtn.com", "sandra.tossou@mtn.com"]  # Tu peux ajouter d'autres destinataires ici
