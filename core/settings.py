...
LOGIN_REDIRECT_URL = 'error_management_systems:dashboard1'  # Redirect to dashboard1 after login
LOGOUT_REDIRECT_URL = '/authentication/login/'  # Redirect to dashboard1 after logout
